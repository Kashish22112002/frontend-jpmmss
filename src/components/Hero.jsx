  ...
  return (
    <section className="bg-orange-50 text-green-800 mx-auto">
      <div className="flex justify-around">
        <div className='w-1/2'>
            <img src={heroImg} alt="" className='max-w-[500px] rounded-md my-4 mx-auto' />
        </div>
        <div className="text-center flex flex-col items-center justify-center w-1/2">
            <h1>{"(logo)"}</h1>
            <h1 className="text-4xl md:text-6xl font-bold">{projectDetails.NAME}</h1>
            <p className="mt-4 text-xl">{projectDetails.DESC}</p>
